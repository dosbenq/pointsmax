...
- Git branch: `jules-6198827409600400756-882e2a23`
- Git commit: `f24a621`

## 1. Executive Snapshot

- User-facing pages: **34**
- API routes: **51**
...
| File | LOC |
|---|---|
| `src/app/profile/page.tsx` | 1019 |
| `src/app/[region]/calculator/hooks/use-calculator-state.ts` | 1009 |
| `src/app/[region]/trip-builder/page.tsx` | 974 |
| `src/app/api/ai/recommend/route.ts` | 799 |
| `src/components/ConnectedWallets.test.tsx` | 788 |
| `src/app/[region]/card-recommender/page.tsx` | 771 |
| `src/app/[region]/award-search/page.tsx` | 759 |
