...
import { CATEGORIES, formatUsdRounded } from '@/lib/card-tools'
    ...
    return cards
      ...
      .map(card => {
        const pointsPerYear = CATEGORIES.reduce((sum, { key }) => {
          ...
          return sum + monthly * multiplier * 12
        }, 0)
      ...
      <main className="pm-shell py-8 w-full space-y-6 flex-1">
        ...
        <div className="text-center py-4">
          <p className="text-[#5f7c70] text-sm">
            ...
            <Link href="/card-recommender" className="text-[#0f766e] hover:underline underline-offset-4 font-medium">
