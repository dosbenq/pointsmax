...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const now = new Date()
  const staticRoutes = ['', 'calculator', 'award-search', 'card-recommender', 'earning-calculator', 'hotel-search', 'how-it-works', 'inspire', 'pricing', 'cards', 'cards/compare', 'programs', 'privacy', 'terms', 'trip-builder']
